...
?>
    ...
    <header id="home">
        ...
        <div class="chgpwd">
	<form action="">
	<font style="padding-left:40%">請輸入新密碼:</font>
	<input type="password" id="chgpwd1" style="width:80px"><br>
	<font style="padding-left:40%">請再次輸入新密碼:</font>
	<input type="password" id="chgpwd2" style="width:80px"><br>
        <input type="button" value="確定更改密碼" class="chgpwd-submit" onclick="changePassword()" style="position:relative; left:40%">
	</form> 	
	</div>
